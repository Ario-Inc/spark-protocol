  ...
  function Device(socket, connectionKey) {
    ...
    _this.onApiMessage = function () {
      var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(sender, message) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                ...
                _context4.next = _context4.t0 === 'Describe' ? 7 : _context4.t0 === 'GetVar' ? 19 : _context4.t0 === 'SetVar' ? 34 : _context4.t0 === 'CallFn' ? 40 : _context4.t0 === 'UFlash' ? 55 : _context4.t0 === 'RaiseHand' ? 59 : _context4.t0 === 'Ping' ? 66 : 70;
                break;
              ...
              case 11:
                ...
                return _context4.abrupt('return', _this._deviceFunctionState);
              ...
              case 18:
                return _context4.abrupt('break', 71);
              ...
              case 44:
                ...
                return _context4.abrupt('return', sendResult);
              ...
              case 50:
                ...
                return _context4.abrupt('return', _sendResult);
        ...
        }, _callee4, _this2, [[8, 15], [20, 29], [41, 50]]);
      }));
    ...
    _this._getVariable = function () {
      var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(name, type) {
    ...
    _this.flashCore = function (binary, sender) {
      if (!binary || binary.length === 0) {
        ...
        _this.sendApiResponse(sender, result);
        return result;
      }
      ...
      if (binary && binary.length > MAX_BINARY_SIZE) {
        ...
        _this.sendApiResponse(sender, _result5);
        return _result5;
      }
      ...
      try {
        ...
        _this.sendApiResponse(sender, _result6);
        ...
        _this.sendApiResponse(sender, _result7);
        return _result7;
      }
    };
